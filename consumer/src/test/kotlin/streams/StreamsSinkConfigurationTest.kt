...
class StreamsSinkConfigurationTest {
    ...
    fun shouldReturnConfigurationFromMap() {
        ...
        val config = Config.builder()
                ...
                .withSetting("streams.sink.topic.cdc", cdctopic)
                .build()
        ...
        assertTrue { streamsConfig.cdcTopics.size == 1 && streamsConfig.cdcTopics.contains(cdctopic) }
    }
    ...
    fun shouldFailWithCrossDefinedTopics() {
        ...
        val config = Config.builder()
                ...
                .withSetting(topicKey, topicValue)
                .withSetting("streams.sink.enabled", "false")
                .withSetting("streams.sink.topic.cdc", topic)
                .build()
